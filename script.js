...
function displayMovies() {
  // who is active tab ??
  if (favTabButton.classList.contains("active")) {
    sortByDateButton.style.display = "none";
    sortByRatingButton.style.display = "none";

    renderFavMovies();
  } else if (allTabButton.classList.contains("active")) {
...
function showFav(favMovie) {
  const { popularity, posterUrl, title, voteAverage } = favMovie;
